...
exports.chosungSearch = chosungSearch;
exports.isBusinessNumber = isBusinessNumber;
exports.withEunNeun = withEunNeun;
exports.withIGa = withIGa;
exports.withEulReul = withEulReul;
const CHOSUNG_LIST = [
    'ㄱ', 'ㄲ', 'ㄴ', 'ㄷ', 'ㄸ', 'ㄹ', 'ㅁ', 'ㅂ', 'ㅃ',
    'ㅅ', 'ㅆ', 'ㅇ', 'ㅈ', 'ㅉ', 'ㅊ', 'ㅋ', 'ㅌ', 'ㅍ', 'ㅎ'
];
 ...
 */
function chosungSearch(str, search) {
